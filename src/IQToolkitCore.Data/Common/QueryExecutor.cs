...
namespace IQToolkit.Data.Common
{
    ...
    public abstract class QueryExecutor
    {
        ...
        /// </summary>
        public abstract IEnumerable<T> Execute<T>(QueryCommand command, Func<FieldReader, T> fnProjector, MappingEntity entity, object[] paramValues) where T : class;
        ...
        /// </summary>
        public abstract IEnumerable<T> ExecuteBatch<T>(QueryCommand query, IEnumerable<object[]> paramSets, Func<FieldReader, T> fnProjector, MappingEntity entity, int batchSize, bool stream) where T : class;
