...
namespace IQToolkit.Data.Common
{
    ...
    public class SqlFormatter : DbExpressionVisitor
    {
        ...
        {
            if (this.forDebug && m.Expression != null)
            {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression m)
        {
            ...
            else if (m.Method.Name == "ToString" && m.Object != null && m.Object.Type == typeof(string))
            {
            ...
            else if (m.Method.Name == "Equals")
            {
                ...
                else if (!m.Method.IsStatic && m.Arguments.Count == 1 && m.Object != null && m.Arguments[0].Type == m.Object.Type)
                {
                    this.Write("(");
                    this.Visit(m.Object);
                    this.Write(" = ");
            ...
            switch (b.NodeType)
            {
                ...
                case ExpressionType.GreaterThanOrEqual:
                    ...
                    if (left.NodeType == ExpressionType.Call && right.NodeType == ExpressionType.Constant)
                    {
                        ...
                        {
                            if (mc.Object != null && mc.Method.Name == "CompareTo" && !mc.Method.IsStatic && mc.Arguments.Count == 1)
                            {
                                left = mc.Object;
